workspace "LIDAR Point Cloud Processing System" "Comprehensive architecture documentation for LIDAR point cloud analysis and visualization application" {
    ...
    model {
        ...
        lidarSystem = softwareSystem "LIDAR Point Cloud Processing System" "Comprehensive suite for processing, analyzing, and visualizing LIDAR point cloud data from vehicle scans" "System" {
            ...
            user -> interactiveSelector "Manipulates cube widget"
            user -> humanPositioner "Positions human models"
            ...
            interactiveSelector -> visualizationEngine "Creates 3D scenes"
            interactiveSelector -> spatialAnalyzer "Calculates spatial selections"
            interactiveSelector -> outputManager "Saves selected regions"
            humanPositioner -> vtkSafetyManager "Uses VTK safety wrappers"
            humanPositioner -> visualizationEngine "Creates human model scenes"
            humanPositioner -> outputManager "Saves human model positions"
    ...
    views {
        ...
        dynamic lidarSystem "CubeSelectionWorkflow" {
            ...
            user -> lidarSystem.guiApp "1. Navigate to Cube Selection tab"
            user -> lidarSystem.guiApp "2. Configure selection options"
            lidarSystem.guiApp -> lidarSystem.interactiveSelector "3. Launch cube selector"
            lidarSystem.interactiveSelector -> lidarSystem.vtkSafetyManager "4. Initialize VTK safely"
            lidarSystem.interactiveSelector -> lidarSystem.visualizationEngine "5. Create 3D scene"
            user -> lidarSystem.interactiveSelector "6. Manipulate cube widget"
            lidarSystem.interactiveSelector -> lidarSystem.spatialAnalyzer "7. Calculate selection"
            lidarSystem.interactiveSelector -> lidarSystem.outputManager "8. Save selected points"
            lidarSystem.outputManager -> fileSystem "9. Write selection file"
            lidarSystem.interactiveSelector -> lidarSystem.guiApp "10. Return selection results"
            lidarSystem.guiApp -> user "11. Display selection summary"
        }
        ...
        container lidarSystem "ProcessingPipeline" {
            ...
            include lidarSystem.vehicleAnalyzer lidarSystem.fileProcessor lidarSystem.spatialAnalyzer lidarSystem.outputManager
            include lidarSystem.vehicleAnalyzer->lidarSystem.fileProcessor lidarSystem.fileProcessor->lidarSystem.spatialAnalyzer lidarSystem.spatialAnalyzer->lidarSystem.outputManager
            autoLayout lr
        }
        ...
        container lidarSystem "UserInterface" {
            ...
            include lidarSystem.launcherApp lidarSystem.guiApp lidarSystem.macosLauncher lidarSystem.interactiveSelector lidarSystem.humanPositioner
            include user->lidarSystem.launcherApp lidarSystem.launcherApp->lidarSystem.guiApp lidarSystem.guiApp->lidarSystem.interactiveSelector lidarSystem.guiApp->lidarSystem.humanPositioner
            autoLayout tb
        }
        ...
        container lidarSystem "VisualizationStack" {
            ...
            include lidarSystem.visualizationEngine lidarSystem.vtkSafetyManager lidarSystem.interactiveSelector lidarSystem.humanPositioner
            include lidarSystem.visualizationEngine->lidarSystem.vtkSafetyManager lidarSystem.interactiveSelector->lidarSystem.vtkSafetyManager lidarSystem.humanPositioner->lidarSystem.vtkSafetyManager
            autoLayout tb
        }
